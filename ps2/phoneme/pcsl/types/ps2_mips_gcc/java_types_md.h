 ...
 * @file
 * @ingroup types
 * @brief Basic types for the ps2_mips_gcc configuration (PS2 Emotion Engine,
 *        MIPS r5900, 32-bit ABI: int = 32-bit, long long = 64-bit).
 *        Identical layout to the other little-endian 32-bit gcc targets.
 */
